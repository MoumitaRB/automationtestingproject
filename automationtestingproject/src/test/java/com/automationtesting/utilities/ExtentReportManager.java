...
public class ExtentReportManager implements ITestListener{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("automationtesting Automation Report"); // Title of report
		htmlReporter.config().setReportName("automationtesting  Functional Testing"); // name of the report
